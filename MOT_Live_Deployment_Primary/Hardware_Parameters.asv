function params = Hardware_Parameters()
    ...
    params.data_folder = 'C:\Users\Dulmith Pitigalage\Thesis_C\Data_Sessions\Session_2026-04-01_16-35-45';
    ...
    params.LIDAR_csv   = fullfile(params.data_folder, 'LiDAR_detections_interpolated.csv');
    ...
    params.tracker.IMM_TPM = [0.97, 0.03; 
                              0.10, 0.90]; 
    % params.tracker.tentative_track_timeout = 1.0;
    % params.tracker.maximum_allowed_hits    = 4;
    % params.tracker.LIDAR_match_threshold   = 0.8;
    % params.tracker.association_threshold   = 60;
    % params.tracker.max_missed_frames       = 8;
    % params.tracker.prediction_rate         = 20;
    % params.tracker.max_time_diff           = 0.05;
    % params.tracker.max_dist_from_origin    = 15;
    % params.tracker.max_possible_velocity   = 15;
    ...
    params.tracker.maximum_allowed_hits    = 4;      % tracks 
    ...
    params.tracker.chi2_probability        = 0.99; 
    params.tracker.measurement_noise_std   = 2.5;    % pixels
