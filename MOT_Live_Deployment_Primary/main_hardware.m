...
% 4. Score tracks according to confidence 
[valid_track_IDs, track_labels] = Helper_Track_Scoring_System(track_histories);
...
% 8. Plot mode probability of the best track 
best_track_ID = 9; 
Plot_Mode_Probability_7(track_histories, best_track_ID); 